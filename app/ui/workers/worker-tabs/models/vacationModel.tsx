        ...
        <form id="vacation-form" action={formAction}>
          ...
          <div className="mb-4">
            ...
            <DateRange
              ...
              onChange={(item: { selection: MyRange }) =>
            ...
            {formState?.errors?.startDate && (
              <p className="text-red-500">{formState.errors.startDate[0]}</p>
            )}
            {formState?.errors?.endDate && (
              <p className="text-red-500">{formState.errors.endDate[0]}</p>
            )}
          </div>
          ...
          <div className="mb-4">
            ...
            {formState?.errors?.reason && (
              <p className="text-red-500">{formState.errors.reason[0]}</p>
            )}
          </div>
          <div className="mb-4">
            ...
            {formState?.errors?.approved && (
              <p className="text-red-500">{formState.errors.approved[0]}</p>
            )}
          </div>
