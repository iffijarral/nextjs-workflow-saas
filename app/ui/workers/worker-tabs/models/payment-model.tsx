      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-lg">
        ...
        >
          ...
          <input
            name="date"
            type="date"
            defaultValue={payment?.date?.substring(0, 10) || ""}
            required
            className="border rounded px-3 py-2"
          />
          {formState?.errors?.date && (
            <p className="text-red-500">{formState.errors.date[0]}</p>
          )}
          ...
          <input
            ...
            type="number"
            step="0.01"
            defaultValue={payment ? (payment.amount / 100).toFixed(2) : ""}
            required
            placeholder="Amount (DKK)"
            className="border rounded px-3 py-2"
          />
          {formState?.errors?.amount && (
            <p className="text-red-500">{formState.errors.amount[0]}</p>
          )}
          ...
          {formState?.errors?.status && (
            <p className="text-red-500">{formState.errors.status[0]}</p>
          )}
          ...
          {formState?.errors?.notes && (
            <p className="text-red-500">{formState.errors.notes[0]}</p>
          )}
